...
### 🚀 リリース
```bash
# 🎯 超簡単リリース（バージョン番号覚えなくてOK）
./release.sh              # 対話的にリリースタイプを選択
./release.sh patch         # パッチリリース（自動でバージョン計算）
./release.sh minor         # マイナーリリース（自動でバージョン計算）
./release.sh major         # メジャーリリース（自動でバージョン計算）

# 📋 従来の方法（バージョン指定）
./release.sh 1.1.0         # マイナーリリース
./release.sh 1.0.1 patch   # パッチリリース
